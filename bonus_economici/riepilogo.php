            ...
            <div class="it-page-sections-container">
                <div class="row">
                    ...
                    <div class="col-12 col-xl-9 body-riepilogo">
                        ...
                        <div class="it-page-section mb-30" id="be_scarica_ricevuta">
                            <div class="cmp-card">
                                <div class="card">
                                    <div class="card-header border-0 p-0 mb-lg-30 m-0">
                                        <div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <form action="../lib/tcpdf/TCPDF-master/examples/be_pdf_pratica.php" method="POST" id="be_frm_download_pdf" name="be_frm_download_pdf">
                                                    ...
                                                    <p class="m-0 text-center"><button type="submit" class="btn btn-primary" id="be_download_pdf" name="be_download_pdf" href="#">Scarica la ricevuta</button></p>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
