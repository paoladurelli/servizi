            ...
            <div class="it-page-sections-container">
                <div class="row">
                                                    ...
                                                    <div id="collapse-one" class="accordion-collapse collapse show" role="region" aria-labelledby="accordion-title-one">
                                                        <div class="accordion-body">
                                                            <ul class="link-list" data-element="page-index">
                                                                <li class="nav-item">
                                                                    <a class="nav-link" href="#be_stato_richiesta">
                                                                        <span class="title-medium">Stato richiesta</span>
                                                                    </a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link" href="#be_scarica_ricevuta">
                    ...
                    <div class="col-12 col-lg-9 body-riepilogo">
                        <div class="it-page-section mb-50 mb-lg-90" id="be_stato_richiesta">
                            <div class="cmp-card">
                                <div class="card">
                                    ...
                                    <div class="card-body" style="margin-bottom:40px;">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <p>Abbiamo ricevuto la tua richiesta per la pratica:<br/><b><?php echo $_GET['pratican']; ?> domanda per bonus economici.</b></p>
                        ...
                        <div class="it-page-section mb-50 mb-lg-90" id="be_scarica_ricevuta">
                            <div class="cmp-card">
                                <div class="card">
                                    <div class="card-header border-0 p-0 mb-lg-30 m-0">
                                        <div>
                                    ...
                                    <div class="card-body" style="margin-bottom:40px;">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <form action="../lib/tcpdf/TCPDF-master/examples/be_pdf_pratica.php" method="POST" id="be_frm_download_pdf" name="be_frm_download_pdf">
                                                    <input type="hidden" name="be_download_pdf_id" id="be_download_pdf_id" value="<?php echo $_GET['praticai']; ?>" />
                                                    <input type="hidden" name="be_download_pdf_pratica" id="be_download_pdf_pratica" value="<?php echo $_GET['pratican']; ?>" />
                                                    <p class="mt-5 text-center"><button type="submit" class="btn btn-primary" id="be_download_pdf" name="be_download_pdf" href="#">Scarica la ricevuta</button></p>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="it-page-section mb-50 mb-lg-90" id="be_prossimi_passi">
                            <div class="cmp-card">
                                <div class="card">
                                    <div class="card-header border-0 p-0 mb-lg-30 m-0">
                                        <div>
                        ...
                        if(!CheckRatingByCfService($_SESSION['CF'],'10')){ 
                            echo CallRatingLayout('be_',$_GET['praticai'],10);
                        }
                        ?>                        
                    </div>
                </div>
