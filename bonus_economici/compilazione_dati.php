                ...
                <div class="it-page-sections-container">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-9 body-compilazione-dati">
                            ...
                            <div class="it-page-section mb-30" id="be_richiedente">
                                <div class="cmp-card">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12"><p id="be_richiedente_nome_txt">Nome *<br/><input type="text" id="be_richiedente_nome" name="be_richiedente_nome" value="<?php echo $nome; ?>" disabled /></p></div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12"><p id="be_richiedente_cognome_txt">Cognome *<br/><input type="text" id="be_richiedente_cognome" name="be_richiedente_cognome" value="<?php echo $cognome; ?>" disabled /></p></div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12"><p id="be_richiedente_cf_txt">Codice Fiscale *<br/><input type="text" id="be_richiedente_cf" name="be_richiedente_cf" value="<?php echo $cf; ?>" disabled /></p></div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12"><p id="be_richiedente_data_nascita_txt">Data di Nascita *<br/><input type="date" id="be_richiedente_data_nascita" name="be_richiedente_data_nascita" value="<?php echo $datanascita; ?>" disabled /></p></div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12"><p id="be_richiedente_luogo_nascita_txt">Luogo di Nascita *<br/><input type="text" id="be_richiedente_luogo_nascita" name="be_richiedente_luogo_nascita" value="<?php echo $luogonascita; ?>" disabled /></p></div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12"><p id="be_richiedente_localita_txt">Località *<br/><input type="text" id="be_richiedente_localita" name="be_richiedente_localita" value="<?php echo $richiedenteLocalita; ?>" disabled /></p></div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12"><p id="be_richiedente_provincia_txt">Provincia *<br/><input type="text" id="be_richiedente_provincia" name="be_richiedente_provincia" value="<?php echo $richiedenteProvincia; ?>" disabled /></p></div>
                                            </div>
                                            <div class="row">
                            ...
                            <div class="it-page-section mb-30" id="be_beneficiario">
                                <div class="cmp-card">
                                    <div class="card">
                                        <div class="card-header border-0 p-0 mb-lg-30 m-0">
                                            <div class="d-flex">
                            ...
                            <div class="it-page-section mb-30" id="be_richiesta">
                                <div class="cmp-card">
                                    <div class="card">
                                        <div class="card-header border-0 p-0 mb-lg-30 m-0">
                                            <div class="d-flex">
                            ...
                            <div class="it-page-section mb-30" id="be_pagamento">
                                <div class="cmp-card">
                                    <div class="card">
                                        <div class="card-header border-0 p-0 mb-lg-30 m-0">
                                            <div class="d-flex">
                            ...
                            <div class="it-page-section mb-30" id="be_allegati">
                                <div class="cmp-card">
                                    <div class="card">
                                        <div class="card-header border-0 p-0 mb-lg-30 m-0">
                                            <div class="d-flex">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="row float-right" id="divButtons">
                                        <button type="button" id="be_btn_back" class="btn btn-default order-lg-1 mr-10"><svg class="icon me-0 me-lg-1 mr-lg-10" aria-hidden="true"><use href="../lib/svg/sprites.svg#it-arrow-left"></use></svg> Indietro</button>
                                        <button type="button" id="be_btn_salva_richiesta" name="be_btn_salva_richiesta" class="btn btn-secondary order-lg-2" data-bs-toggle="modal" data-bs-target="#SalvaRichiestaModal">Salva richiesta</button>                                        
                                        <button type="button" id="be_btn_concludi_richiesta" name="be_btn_concludi_richiesta" class="btn btn-primary order-lg-3">Avanti <svg class="icon me-0 me-lg-1 mr-lg-10" aria-hidden="true"><use href="../lib/svg/sprites.svg#it-arrow-right"></use></svg></button>
                                    </div>
                                </div>
                            </div>
                        </div>
