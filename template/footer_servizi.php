            ...
            <div class="it-footer-main">
                <div class="container">
                    ...
                    <section class="py-4 border-white">
                        <div class="row">
                            <div class="col-md-4 col-lg-3 pb-2 hide-mobile-footer" style="">
                            ...
                            <div class="col-md-8 col-lg-6 pb-2 hide-mobile-footer" style="">
                                        ...
                                        <div id="it-region-footer-second" class="region footer_second">
                                            <div id="it-block-categoriediservizio" class="block block-block-content">
                                                <div class="clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item">
                                                    ...
                                                    <p aria-controls="menu-lista-altre" aria-expanded="false" data-toggle="collapse" id="footer-menu-lista-button" role="button" style="margin-left: -10px; font-size: 0.85rem; display: inline-flex;"><svg class="icon"> <use href="../lib/svg/sprites.svg#it-more-items" xlink:href="../lib/sprites.svg#it-more-items"></use> </svg> <span class="footer-menu-lista-apri" title="Espandi">Espandi</span> <span class="footer-menu-lista-chiudi" title="Chiudi">Chiudi</span></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div id="it-block-footer1" class="block block-block-content">
                                                <div class="clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item">
                                                    <p><strong>Comune di <?php echo $configData['nome_comune']; ?></strong><br>
                                                        ...
                                                        C.F./P.IVA: <?php echo $configData['CFPIVA_comune']; ?><br/>
                                                        Tel. <?php echo $configData['tel_comune']; ?><br>
                                                    <div class="link-list-wrapper">
                                                        <ul class="footer-list link-list clearfix">
                                                            <li><a class="list-item" href="mailto:<?php echo $configData['pec_comune']; ?>" title="Posta Elettronica Certificata"><?php echo $configData['pec_comune']; ?></a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
