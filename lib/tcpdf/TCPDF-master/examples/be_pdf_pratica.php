...
$numeroPratica = $_POST['be_download_pdf_pratica'];

/* con l'id vado a richiamare i dati salvati */
    if(isset($_POST["be_download_pdf_id"]) && $_POST["be_download_pdf_id"]<>''){
        /* DATI ESTRAPOLATI DA DB - start */ 
        $connessione = mysqli_connect($configDB['db_host'],$configDB['db_user'],$configDB['db_pass'],$configDB['db_name']);
        $sql = "SELECT * FROM bonus_economici WHERE richiedenteCf = '". $_SESSION['CF']."' and id =" . $_POST["be_download_pdf_id"];
...
.styled-table tbody tr.active-row {
 ...
 <br><h1> Richiesta bonus economici - <em>Ricevuta</em> </h1>
 <br>
 <br>
 <br>
