...
$pdf->merge('browser', 'Stampa_domanda.pdf');

unlink('temp/'.$id.'_temporary.pdf');

//$pdf2->addPDF('../../../allegati/82/1_1649343181_prova.pdf');
//$pdf2->merge('download','merged.pdf');
