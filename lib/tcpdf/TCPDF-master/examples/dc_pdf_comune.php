...
/* con l'id vado a richiamare i dati salvati */
    if(isset($new_id) && $new_id<>''){
        ...
        $sql = "SELECT * FROM domanda_contributo WHERE richiedenteCf = '". $_SESSION['CF']."' and id =" . $new_id;
...
switch($inQualitaDi) {
    case "D": 
        ...
        $documentazioneRichiesta = "documentazione utile al riconoscimento del contributo (esempi: contratto affitto, bollette, spese sanitarie, debiti…)<br>";
        break;
    case "T": 
        $qualita .= "<b>tutore</b> ";
        $qualita .= "di<br>
...
/*if($inQualitaDi == "D"){
    $modalitaPagamento .= " su c/c intestato a me medesimo";
}else{
    $modalitaPagamento .= " su c/c intestato a <b>".$beneficiarioCognome." ".$beneficiarioNome."</b><br>
        C.F. <b>".$beneficiarioCf."</b><br>";
}*/																														
...
<table>
    ...
    <tr>
        <td style="padding: 12px 10px; text-align: center;">
            <h3>DOMANDA DI CONTRIBUTO ECONOMICO</h3>
        </td>
    </tr>
    <tr>
