...
$numeroPratica = $_POST['pm_download_pdf_pratica'];

/* con l'id vado a richiamare i dati salvati */
    if(isset($_POST["pm_download_pdf_id"]) && $_POST["pm_download_pdf_id"]<>''){
        /* DATI ESTRAPOLATI DA DB - start */ 
        $connessione = mysqli_connect($configDB['db_host'],$configDB['db_user'],$configDB['db_pass'],$configDB['db_name']);
        $sql = "SELECT * FROM pubblicazione_matrimonio WHERE richiedenteCf = '". $_SESSION['CF']."' and id =" . $_POST["pm_download_pdf_id"];
...
.styled-table tbody tr.active-row {
 ...
 <br><h1> Domanda contributo - <em>Ricevuta</em> </h1>
 <br>
 <br>
 <br>
...
<table style="padding: 12px 10px;">
    ...
    <tr>
        <th style="padding: 12px 10px; width: 40%; font-weight: 600;">Stato Civile</th>
        <td style="padding: 12px 10px; width: 60%; font-weight: normal;">$richiedenteStatoCivile</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="padding: 12px 10px; width: 60%; font-weight: normal;">$luogonascita ($richiedenteStatoNascita)</td>
    </tr>
    <tr>
        <th style="padding: 12px 10px; width: 40%; font-weight: 600;">Atto di Nascita</th>
        <td style="padding: 12px 10px; width: 60%; font-weight: normal;">n. $richiedenteAttoNascita del $richiedenteAttoNascitaData</td>
    </tr>
    <tr>    
...
<table style="padding: 12px 10px;">
    <tr>
        <th style="padding: 12px 10px; width: 40%; font-weight: 600;">Nome e Cognome</th>
        <td style="padding: 12px 10px; width: 60%; font-weight: normal;">$coniugeNome $coniugeCognome</td>
    </tr>
    <tr>
        <th style="padding: 12px 10px; width: 40%; font-weight: 600;">Codice Fiscale</th>
        <td style="padding: 12px 10px; width: 60%; font-weight: normal;">$coniugeCf</td>
    </tr>
    <tr>
        <th style="padding: 12px 10px; width: 40%; font-weight: 600;">Stato Civile</th>
        <td style="padding: 12px 10px; width: 60%; font-weight: normal;">$coniugeStatoCivile</td>
    </tr>
    <tr>
        <th style="padding: 12px 10px; width: 40%; font-weight: 600;">Data di Nascita</th>
        <td style="padding: 12px 10px; width: 60%; font-weight: normal;">$coniugeDataNascita</td>
    </tr>
    <tr>
        <th style="padding: 12px 10px; width: 40%; font-weight: 600;">Luogo di Nascita</th>
        <td style="padding: 12px 10px; width: 60%; font-weight: normal;">$coniugeLuogoNascita ($coniugeStatoNascita)</td>
    </tr>
    <tr>
        <th style="padding: 12px 10px; width: 40%; font-weight: 600;">Atto di Nascita</th>
        <td style="padding: 12px 10px; width: 60%; font-weight: normal;">n. $coniugeAttoNascita del $coniugeAttoNascitaData</td>
    </tr>
    <tr>    
        <th style="padding: 12px 10px; width: 40%; font-weight: 600;">Residente a</th>
        <td style="padding: 12px 10px; width: 60%; font-weight: normal;">$coniugeLocalita - $coniugeProvincia</td>
    </tr>
    <tr>
        <th style="padding: 12px 10px; width: 40%; font-weight: 600;">In Via</th>
        <td style="padding: 12px 10px; width: 60%; font-weight: normal;">$coniugeVia</td>
    </tr>
    <tr>
        <td style="padding: 12px 10px; width: 40%; font-weight: 600;">Telefono</td>
        <td style="padding: 12px 10px; width: 60%; font-weight: normal;">$coniugeTel</td>
    </tr>
    <tr>
        <td style="padding: 12px 10px; width: 40%; font-weight: 600;">Email</td>
        <td style="padding: 12px 10px; width: 60%; font-weight: normal;">$coniugeEmail</td>
    </tr>
</table>
EOD;
...
<table style="padding: 12px 10px;">
<tr>
  <td style="text-transform:capitalize; padding: 12px 10px;">$pagamento</td>
</tr>
</table>*/
