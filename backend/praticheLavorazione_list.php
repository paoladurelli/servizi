                    ...
                    <div class="cmp-breadcrumbs" role="navigation">
                        <nav class="breadcrumb-container">
                            <ol class="breadcrumb p-0" data-element="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span class="separator">/</span>Pratiche In Lavorazione</li>
                            </ol>
                        </nav>
                    </div>
                        ...
                        <div class="it-page-section mb-50 mb-lg-90" id="attivita">
                            <div class="row mb-20 mt-3">
                                <div class="col-12 title-pratiche pb-3 mb-3 after-section">
                                    <img src="..\media\images\icons\status_3.png" title="Pratiche In Lavorazione" alt="Pratiche In Lavorazione"/><h5>Pratiche In Lavorazione</h5>
                                </div>
                                <?php include 'praticheLavorazione_main.php'; ?>
                            </div>
