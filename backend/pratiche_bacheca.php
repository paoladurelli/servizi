        ...
        <div class="modal-dialog" role="dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title h5 no_toc" id="confirmDialogTitle">Elimina pratica</h2>
                </div>
                <div class="modal-body">
                    <p>Cliccando su "Elimina" la pratica verrà cancellata definitivamente.</p>
                    <h6>Vuoi eliminare la pratica?</h6>
                </div>
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary btn-sm deletePratica" type="submit">Elimina</button>
                </div>
            </div>
        </div>
    </div>