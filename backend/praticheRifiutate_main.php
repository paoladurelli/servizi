                                    ...
                                    <div class="col-lg-12">
                                        <div class="row">';
                                            echo '<div class="col-12 text-right">
                                                <a href="#" class="btn-small btn-primary btn-with-icon creaBozza" data-id="'.$row["pratica_id"].'" data-servizio="'.$row["ServizioId"].'" data-numero="'.NumeroPraticaById($row["ServizioId"],$row["pratica_id"]).'">Genera nuova bozza<svg class="icon" aria-hidden="true"><use href="../lib/svg/sprites.svg#it-file"></use></svg></a>
