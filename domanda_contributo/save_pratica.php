        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                /* mando mail al comune - start */
                    ...
                    $phpmailer->Username = 'sviluppo@proximalab.it';
                    $phpmailer->Password = 'Magnetica18';
                    ...
                    $phpmailer->Subject = 'Comune di '. $configData['nome_comune'] . ' - Domanda di contributo ';
                    $phpmailer->isHTML(true);
                    $phpmailer->CharSet('UTF-8');
                    $mailContent = '
                        <p>L\'utente ' . $_SESSION['Nome'] . ' ' . $_SESSION['Cognome'] . ' ha inviato una domanda contributo.<br/>'
                ...
                /* mando mail all'utente - start */
                    ...
                    $phpmailer2->isSMTP();
                    $phpmailer2->Host = 'smtp.office365.com';
                    $phpmailer2->SMTPAuth = true;
                    $phpmailer2->Port = 587;
                    $phpmailer2->SMTPSecure = "PHPMailer::ENCRYPTION_STARTTLS";
                    $phpmailer2->Username = 'sviluppo@proximalab.it';
                    $phpmailer2->Password = 'Magnetica18';
                    ...
                    $mailContent2 = '
                        <p>Ciao ' . $_SESSION['Nome'] . ' ' . $_SESSION['Cognome'] . ', la tua domanda contributo &egrave; stata inviata correttamente.<br/>'
                        . 'Il numero della pratica &egrave;: <b>'.$NumeroPratica.'</b><br/>
