<?php 
    ...
    if(isset($_GET["pratican"]) && $_GET["pratican"]<>''){
        ...
        $sql = "SELECT * FROM domanda_contributo WHERE richiedenteCf = '". $_SESSION['CF']."' and id =" . $_GET["pratican"];
    ...
    <main>
        <div class="container" id="main-container">
            ...
            <div class="it-page-sections-container">
                                                    ...
                                                    <div id="collapse-one" class="accordion-collapse collapse show" role="region" aria-labelledby="accordion-title-one">
                                                        <div class="accordion-body">
                                                            <ul class="link-list" data-element="page-index">
                                                                ...
                                                                <li class="nav-item">
                                                                    <a class="nav-link" href="#dc_dichiarazioni">
                ...
                <div class="row" id="dc_dichiarazioni">
                    <div class="col-12 col-lg-9 offset-lg-3 mb-30">
                ...
                <div class="row">
                    <div id="divButtons" class="col-lg-12 text-right mb-30">
                        ...
                        <form method="POST" action="#" name="dc_conferma_invia" id="dc_conferma_invia" class="display-inline">
