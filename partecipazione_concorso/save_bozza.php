...
$richiedenteNome = isset($_POST['dc_richiedente_nome']) ? addslashes($_POST['dc_richiedente_nome']) : "";
$richiedenteCognome = isset($_POST['dc_richiedente_cognome']) ? addslashes($_POST['dc_richiedente_cognome']) : "";
...
$richiedenteLuogoNascita = isset($_POST['dc_richiedente_luogo_nascita']) ? addslashes($_POST['dc_richiedente_luogo_nascita']) : "";
$richiedenteVia = isset($_POST['dc_richiedente_via']) ? addslashes($_POST['dc_richiedente_via']) : "";
$richiedenteLocalita = isset($_POST['dc_richiedente_localita']) ? addslashes($_POST['dc_richiedente_localita']) : "";
...
$beneficiarioNome = isset($_POST['dc_beneficiario_nome']) ? addslashes($_POST['dc_beneficiario_nome']) : "";
$beneficiarioCognome = isset($_POST['dc_beneficiario_cognome']) ? addslashes($_POST['dc_beneficiario_cognome']) : "";
...
$beneficiarioLuogoNascita = isset($_POST['dc_beneficiario_luogo_nascita']) ? addslashes($_POST['dc_beneficiario_luogo_nascita']) : "";
$beneficiarioVia = isset($_POST['dc_beneficiario_via']) ? addslashes($_POST['dc_beneficiario_via']) : "";
$beneficiarioLocalita = isset($_POST['dc_beneficiario_localita']) ? addslashes($_POST['dc_beneficiario_localita']) : "";
