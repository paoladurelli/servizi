                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body" id="pc_pnl_dichiarazioni">
                                        ...
                                        <?php if( $conoscenzaInformatica == 1){ ?>
                                            <div class="row mb-30">
                                                <div class="col-lg-12">
                                                    di conoscere l’uso delle apparecchiature, delle applicazioni informatiche più diffuse e di scegliere la seguente lingua straniera <b><?php echo $conoscenzaLinguaEstera; ?></b>
                                                </div>
                                            </div>
                                        <?php } ?>
