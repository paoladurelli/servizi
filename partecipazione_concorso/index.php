                                ...
                                <div class="card">
                                    <div class="card-body p-0">
                                        ...
                                        <form name="frm_privacy" action="compilazione_dati.php" method="post">
                                            <p class="mt-50 mt-md-5 mt-lg-0 mb-50 mb-md-5 mb-lg-4"><label><input type="checkbox" name="ckb_privacy" required /> <b>Ho letto e compreso l'informativa sulla privacy</b></label></p>
