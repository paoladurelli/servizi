                        ...
                        <div class="col-12 col-lg-9 body-compilazione-dati">
                            ...
                            <div class="row">
                                <div class="col-12" id="divButtons">
                                    <button type="button" id="pm_btn_concludi_richiesta" name="pm_btn_concludi_richiesta" class="btn btn-primary">Avanti <svg class="icon me-1 mr-lg-10" aria-hidden="true"><use href="../lib/svg/sprites.svg#it-arrow-right"></use></svg></button>
                                    ...
                                    <button type="button" id="pm_btn_back" class="btn btn-default"><svg class="icon me-1 mr-lg-10" aria-hidden="true"><use href="../lib/svg/sprites.svg#it-arrow-left"></use></svg> Indietro</button>
                                </div>
                            </div>
                        </div>
                    </div>
